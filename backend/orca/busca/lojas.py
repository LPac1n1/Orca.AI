...
- `modo: pagina` — a página de busca do próprio site, aberta pelo navegador sem janela;
  `produto` é o pedaço do endereço que identifica a página de um produto;
- `modo: assistida` — a loja recusa programas (D-67): a janela abre na busca e a pessoa escolhe.
Sem `busca`, a loja só entra colando o link.
"""

from dataclasses import dataclass
from urllib.parse import quote

MODOS_AUTOMATICOS = ("api_vtex", "pagina")
...
CATEGORIA_DA_LOJA = {
    ...
    "limpeza": "limpeza", "higiene": "limpeza", "descartavel": "descartaveis",
