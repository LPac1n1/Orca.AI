...
**Código de barras primeiro (D-75):** ao cadastrar um item sem código de barras, o sistema mostra uma **vitrine** com os produtos que as lojas de busca automática (as que vendem o tipo do item) trazem para a descrição: foto, nome, prévia do preço e loja. O usuário clica em **"É este"** no produto certo; a página é lida como prova, fica 🟢 por decisão dele e vira o produto de referência, e o código de barras dela guia as buscas nas outras lojas. A vitrine também pode ser aberta depois ("escolher o produto", no cadastro, na pesquisa e no "Fechar o lote"). Se o produto não aparece, o usuário digita o código de barras da embalagem ou cola o link da página.
