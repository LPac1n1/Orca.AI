...
- **Tempo:** a página de busca tem limite de 25 s; loja que não responde é pulada. Três buscas seguidas sem nenhum produto do tipo do item (de qualquer marca) numa loja: a loja não vende o lote (ou a busca dela mudou) e os outros itens nela são poupados, com o motivo no resumo.
